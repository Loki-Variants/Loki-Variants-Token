...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minimumTokenBalanceForDividends = 210 * (10**9); // user must hold 210 token
...
contract VARIANTS is
    BASEToken("Loki Variants Fan Token", "VARIANTS", 21000000 * (10**9), 9),
    SafeToken,
    LockToken
{
    using SafeMath for uint256;
